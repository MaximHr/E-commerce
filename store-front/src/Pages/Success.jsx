    ...
    return (
        <div className='about container success' id='about'>
            ...
            <p className="about-info">
                Your payment has been processed successfully. We are preparing your order and will update you once it’s
                delivered to your address. If you have any questions, feel free to contact us at doroty@shop.com
            </p>
