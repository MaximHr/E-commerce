  ...
  return (
    <div className="about container" id="about" ref={aboutRef}>
      ...
      <p className="about-info">
        Welcome to Dorothy Plushies, where cuddles and creativity come to life!
        Founded with a passion for bringing joy and comfort to children and
        adults alike, Dorothy Plushies specializes in creating high-quality,
        uniquely designed plush toys that spark the imagination and warm the
        heart.
      </p>
      <div className="about-table">
        ...
        <div className="cell">
          ...
          <p className="cell-text">
            ...
            <span className="bold">dorothy@shop.com</span>
          </p>
        </div>
        <div className="cell">
          ...
          <p className="cell-text">
            We partner with Stripe to make sure that your payment information is
            processed securely.
          </p>
        </div>
      </div>
